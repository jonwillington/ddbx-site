...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex items-center gap-3 rounded-xl border border-separator bg-[#fcfbf9]/95 dark:bg-background/95 backdrop-blur-md shadow-lg px-4 py-2 text-xs text-foreground/70">
