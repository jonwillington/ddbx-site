...
export function CookieBanner() {
  ...
  return (
    <div
      aria-hidden={!inView}
      className={`fixed inset-x-0 bottom-4 z-50 flex justify-center px-4 pointer-events-none transition-all ease-out ${inView ? "translate-y-0 opacity-100 duration-300" : "translate-y-24 opacity-0 duration-300"}`}
    >
