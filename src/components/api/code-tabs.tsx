...
export function CodeTabs({
  ...
  return (
    <div className={className}>
      <div
        aria-label="Language"
        className="mb-3 inline-flex rounded-control bg-white/[0.06] p-0.5"
        role="tablist"
      >
        {snippets.map((s, i) => (
          <button
            ...
            className={`rounded-control px-3 py-1.5 font-mono text-caption font-semibold transition-colors ${
              i === active
                ? "bg-white text-ink"
