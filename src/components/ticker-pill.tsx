...
export function TickerPill({
  ...
  return (
    <span
      className={`inline-block shrink-0 rounded-full bg-hairline px-2 font-mono text-caption font-semibold tabular-nums text-foreground/70 dark:bg-surface-secondary ${className}`}
    >
      {ticker}
    </span>
  );
