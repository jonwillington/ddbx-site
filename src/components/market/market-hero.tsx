      ...
      >
        ...
        {(primaryCtaHref || onExplain || onViewReport) && (
          <div className="flex flex-wrap items-center justify-center gap-3">
            {primaryCtaHref && (
              <a
                className="inline-flex items-center gap-2 rounded-full bg-[#5a4128] px-6 py-3 text-base font-semibold text-white shadow-md transition-all hover:bg-[#49331f] hover:shadow-lg dark:bg-[#ad9479] dark:text-[#1a140d] dark:hover:bg-[#bda58a]"
                href={primaryCtaHref}
