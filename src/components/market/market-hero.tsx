      ...
      >
        ...
        {(primaryCtaHref || onExplain || onViewReport) && (
          <div className="flex flex-wrap items-center justify-center gap-3">
            {/* App-store CTA is md+ only — on mobile the persistent floating
                download bar (DefaultLayout) is the install nudge, so the hero
                stays headline + explainer and the CTA isn't shown twice. */}
            {primaryCtaHref && (
