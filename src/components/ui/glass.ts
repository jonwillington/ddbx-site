 ...
 *
 *  Material and shadow only: radius, padding and position stay at the call
 *  site. (The navbar's own shadow is a slightly softer one-off; the chrome
 *  sweep settles it onto shadow-float.)
...
const GLASS: Record<GlassTone, string> = {
  page: "border border-black/7 bg-page/60 shadow-float backdrop-blur-2xl backdrop-saturate-[2.5] dark:border-white/9 dark:bg-background/60",
  stage:
