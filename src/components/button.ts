...
export const BUTTON_RADIUS = "rounded-control";
 ...
 *
 *  The hover step is `ink-hover` (--color-ink-hover).
 *
...
export const BUTTON_FILLED =
  "bg-ink text-white hover:bg-ink-hover dark:bg-white dark:text-ink dark:hover:bg-white/90";
...
export const BUTTON_GHOST =
  "bg-ink/7 text-ink hover:bg-ink/12 dark:bg-white/10 dark:text-white dark:hover:bg-white/16";
...
export const BUTTON_FILLED_GROUP =
  "bg-ink text-white group-hover:bg-ink-hover dark:bg-white dark:text-ink dark:group-hover:bg-white/90";
