  ...
  return (
    ...
    >
      ...
      {/* The footer is a raised sheet on the page, not a band ruled off from it:
          a bordered box inside the content column, with the crossing sweep
          running underneath it. The box's own edge and shadow do the separating
          the old full-width `border-t` did. The bottom padding is the sweep's
          room — FooterTrail pins itself to the bottom of this <footer> at
          130px, 200px from md, so these two pairs have to move together. */}
      <footer className="relative w-full pt-14 pb-[130px] md:pt-20 md:pb-[200px]">
        <FooterTrail />
