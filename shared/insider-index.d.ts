...
export declare function isWeekday(iso: string | null | undefined): boolean;
export declare function prevWeekday(
  iso: string,
  inclusive?: boolean,
): string | null;
export declare function nextWeekday(
  iso: string,
  inclusive?: boolean,
): string | null;
export declare function weekdaysBetween(from: string, to: string): string[];
...
export interface SeriesOptions {
  /** ISO. Defaults to today in London; never later than it. */
  to?: string;
